...
export const achieveReward = (rewardsStates, gameState) => {
...
const runGame = () => {
  ...
  while (keeRunning) {
    ...
    keeRunning =
      rewardsStates[0].foundCount < rewardsStates[0].aimCount ||
      rewardsStates[1].foundCount < rewardsStates[1].aimCount;
  }
